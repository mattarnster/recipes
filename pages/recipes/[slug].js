    ...
    return (
      ...
      <div className="container-sm mx-auto mt-4">
        ...
        <div className="mt-10 px-4 py-2">
            <h1 className="text-4xl text-center font-bold mb-2 mt-2 text-white px-2 py-2 bg-black tracking-wide">{ recipe.title }</h1>
            ...
            <div className="grid grid-cols-2 gap-4 mt-4">
                ...
                <div className="ingredients bg-black text-white px-4 py-4">
                    <h1 className="tracking-wide text-center text-2xl">INGREDIENTS</h1>
